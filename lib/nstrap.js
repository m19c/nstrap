...
var isUndefined  = require('lodash.isundefined'),
    ...
    util         = require('util'),
    NStrapModule = require('./nstrap-module');
...
NStrap.prototype.addModule = function addModule(instance) {
  if (!(instance instanceof NStrapModule)) {
    throw new Error(util.format('The passed argument "%s" is not an instance of NStrapModule', instance));
  }
...
NStrap.prototype.add = function add(name, dependencies, task, supplier) {
  ...
  if (name instanceof NStrapModule) {
  ...
  return this.addModule(instance);
};
